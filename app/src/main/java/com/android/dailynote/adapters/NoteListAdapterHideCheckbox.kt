...
class NoteListAdapterHideCheckbox(private val clickListener: NoteListListener)
    :androidx.recyclerview.widget.ListAdapter<NoteVO,NoteListAdapterHideCheckbox.ListViewHolder>(NoteListHideCheckboxDiffCallback()) {
...
class NoteListHideCheckboxDiffCallback : DiffUtil.ItemCallback<NoteVO>(){
